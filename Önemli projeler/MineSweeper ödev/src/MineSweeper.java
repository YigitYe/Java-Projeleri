...
Opennig_Button++;
        ...
        Opennig_Button++;
           //bu recursive bastıgımız yerin solunu sagını kontrol eder
        open(row - 1, col);   // satırın üstünü açmaz
        open(row + 1, col);  //satırın üstünü acar altı bos
        open(row,col-1);      //sutunun sol tarafı bossa ilerler
        open(row,col+1);
    }
}
