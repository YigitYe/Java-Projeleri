...
public void countingArround(int row,int col){
  ...
  for(int k=col-1;k<=col+1;k++){
    ...
    //mayınlı olan yere kadar devam etsin methodu
public void open(int row,int col){
    if (row < 0 || row >= board.length || col < 0 || col >= board[0].length || board[row][col].getText().length() > 0
        ...
        board[row][col].setText(board[row][col].getCount() + "");
        board[row][col].setEnabled(false); //setEnabled false acmak demek(bos alanlara sayı yazar)
...
Opennig_Button++;
        ...
        Opennig_Button++;
        open(row - 1, col);   //bu recursive bastıgımız yerin solunu sagını kontrol eder
        open(row + 1, col);
        open(row, col - 1);
        open(row, col + 1);
    }
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if (e.getButton()==1){
           ...
           open(b.getRow(), b.getCol());   // yukarda yaptıgımz open recursiveinde bastıgımız nokta
    ...
    public void mouseEntered(MouseEvent e) {
        ...
        if(b.isMine()){
            board[b.getRow()][b.getCol()].setEnabled(false);
            board[b.getRow()][b.getCol()].setText("💣");
        }
        else{
            board[b.getRow()][b.getCol()].setEnabled(false);
            board[b.getRow()][b.getCol()].setText( board[b.getRow()][b.getCol()].getCount()+"");
        }
    ...
    public void mouseExited(MouseEvent e) {
        Buton b= (Buton) e.getComponent();
        if(!b.isFlag()&&b.isMine()){

            board[b.getRow()][b.getCol()].setEnabled(true);
            board[b.getRow()][b.getCol()].setText(null);
        }
else{
            board[b.getRow()][b.getCol()].setEnabled(true);
            board[b.getRow()][b.getCol()].setText(null);
